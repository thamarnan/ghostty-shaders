...
// Blue blaze variant: original manga_slash water-blue palette, only on larger cursor jumps.
...
const vec3 BLAZE_GOLD = vec3(0.3, 0.7, 1.0);
const vec3 BLAZE_ORANGE = vec3(0.1, 0.4, 0.8);
const vec3 BLAZE_WHITE = vec3(0.8, 0.9, 1.0);
const vec3 BLAZE_RED = vec3(0.1, 0.4, 0.8);
