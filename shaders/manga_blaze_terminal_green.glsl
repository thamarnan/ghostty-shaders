...
// Terminal-green blaze variant, only on larger cursor jumps.
...
const vec3 BLAZE_GOLD = vec3(0.22, 1.0, 0.42);
const vec3 BLAZE_ORANGE = vec3(0.0, 0.62, 0.18);
const vec3 BLAZE_WHITE = vec3(0.75, 1.0, 0.82);
const vec3 BLAZE_RED = vec3(0.0, 0.22, 0.08);
