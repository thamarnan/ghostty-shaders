...
// Glowing-white blaze variant, only on larger cursor jumps.
...
const vec3 BLAZE_GOLD = vec3(0.92, 0.96, 1.0);
const vec3 BLAZE_ORANGE = vec3(0.72, 0.84, 1.0);
const vec3 BLAZE_WHITE = vec3(1.0, 1.0, 1.0);
const vec3 BLAZE_RED = vec3(0.5, 0.62, 0.75);
